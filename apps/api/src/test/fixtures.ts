...
export async function resetTestDatabase() {
  ...
  await sql`TRUNCATE TABLE rounds, games, locations, sessions, users, streetview_panorama_usage, championship_matches, championship_participants, championships RESTART IDENTITY CASCADE`;
